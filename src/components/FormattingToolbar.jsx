...
const FormattingToolbar = ({ 
  ...
  return (
    <div id="formatting-toolbar" className="min-h-10 bg-gray-50 dark:bg-[#0d1117] border-b border-gray-200 dark:border-gray-800 flex items-center flex-wrap px-4 py-1 space-x-1 shrink-0">
...
`, '', '')} title={`Table (${formatShortcut(shortcuts.table)})`} />
      ...
      <div className="relative inline-block">
        ...
        {showEmojiPicker && (
          <div ref={emojiPickerRef} className="absolute top-full mt-2 left-0 z-50 bg-white dark:bg-[#161b22] border border-gray-200 dark:border-gray-800 p-3 rounded-lg shadow-xl w-64 animate-in fade-in slide-in-from-top-2">
