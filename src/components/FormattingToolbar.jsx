...
const FormattingToolbar = memo(({ 
  ...
  return (
    <div id="formatting-toolbar" className="h-10 bg-gray-50 dark:bg-[#0d1117] border-b border-gray-200 dark:border-gray-800 flex items-center flex-wrap px-4 py-1 space-x-1 shrink-0">
