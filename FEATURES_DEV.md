...
- **Top-Aligned Toolbars & Stats:** Relocated the custom Formatting Toolbar and the Document Statistics bar from the bottom of the screen to the top of their respective panes (Editor and Preview), placing them immediately below the main application Toolbar.
